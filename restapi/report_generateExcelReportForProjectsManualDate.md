...
BeOnTime umozliwia generowanie raportow, ktore zawieraja informacje na temat czasu pracy. Wymagana rola: manager.

### generateReport()

generateReport() sluzy do wygenerowania raportu EXCEL. Raport ten zawiera informacje o czasie pracy wszystkich uzytkowanikow w danym okresie czasu i dla danych projektow. 

|Attribute|	Type|	Required|	Description|
|---|---|---|---|
| projectNames | List<String> | yes | @RequestParam |
| fromDate | LocalDate | yes | @RequestParam |
| toDate | LocalDate | yes | @RequestParam |

#### Przyklad zadania:

`GET /manager/timesheets/report/?projectNames=Uniqa&fromDate=2023-03-01&toDate=2023-03-31 HTTP/1.1`    
