...
|---|---|---|---|
| departmentUuid | UUID | yes | UUID departamentu, z ktorego, chcemy usunac managera |
| managerUuid | UUID | yes | UUID managera, ktorego chcemy usunac z departamentu| 

#### Przyklad zadania:

`DELETE /departments/22393876-2885-49c8-b321-e58119dda98b/managers/5c578189-fc7b-47c2-9915-68dad34b5cd5 HTTP/1.1`  
