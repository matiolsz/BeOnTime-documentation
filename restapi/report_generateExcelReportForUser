...
generateReport() sluzy do wygenerowania raportu EXCEL. Raport ten zawiera informacje o czasie pracy dane uzytkownika w danym miesiacu.
...
`GET /manager/timesheets/report?userUuid=28dcbd9c-bc1d-11ed-afa1-0242ac120002&month=3&year=2023 HTTP/1.1`  
